...
[Use this template repo](https://github.com/davegrays/ds-ml-template)
...
This is a difference in focus. The template repository is centered around code organization and best practices, and designed as a general-purpose solution that can be adapted to various DS and ML projects. Workflow management systems are focused on orchestrating and managing the execution of tasks in a workflow. The template repo helps you write better code, while a WMS helps you manage the execution of that code.

Ideally they would be used together. You can structure your pipelines using the template repository and then use a workflow management system to define, schedule, and monitor its execution. A WMS like kubeflow, metaflow, prefect, or airflow is designed to handle many challenges this repo doesn't address, like parallelization, resource management, and monitoring. It's a good idea to integrate your code eventually with one of these systems.
